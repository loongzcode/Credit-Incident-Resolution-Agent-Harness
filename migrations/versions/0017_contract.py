...
def upgrade():
    if op.get_bind().dialect.name == "postgresql":
        ...
        op.alter_column("investigation_safe_traces", "projection_version", nullable=False)
        ...
        with op.batch_alter_table("investigation_safe_traces") as batch:
            batch.alter_column("projection_version", existing_type=sa.String(16), nullable=False)
