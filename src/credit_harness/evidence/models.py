...
class ClaimType(StrEnum):
    ...
    CONSUMER_DEPLOYED_SCHEMA_VERSION = "CONSUMER_DEPLOYED_SCHEMA_VERSION"
    CONSUMER_ACCEPTED_PROTOCOL_VERSION = "CONSUMER_ACCEPTED_PROTOCOL_VERSION"
    CONSUMER_LOAN_NO_FIELD_TYPE = "CONSUMER_LOAN_NO_FIELD_TYPE"
    ...
    ASSET_DELIVERY_EVENT_REF = "ASSET_DELIVERY_EVENT_REF"
